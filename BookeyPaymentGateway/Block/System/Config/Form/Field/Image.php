 ...
 */
namespace Bookey\BookeyPaymentGateway\Block\System\Config\Form\Field;
...
class Image extends \Magento\Config\Block\System\Config\Form\Field 
{
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        if (!(string)$element->getValue()) {
            $defaultImage = $this->getViewFileUrl('Bookey_BookeyPaymentGateway::images/bookey_logo.png');
            
            $html .= '<img src="' . $defaultImage . '" alt="Bookey logo" height="50" width="85" class="small-image-preview v-middle" />';
