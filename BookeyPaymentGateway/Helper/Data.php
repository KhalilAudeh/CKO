...
/**
 * Class Bookey_BookeyPaymentGateway_Helper_Data
 *
 * Provides helper methods for retrieving data for the bookey plugin
 */
class Data extends AbstractHelper {

    /**
     * @var \Bookey\BookeyPaymentGateway\Gateway\Config\Config
     */
    ...
    /**
     * @param \Bookey\BookeyPaymentGateway\Gateway\Config\Config $gatewayConfig
     ...
     * @param  \Magento\Framework\ObjectManagerInterface $objectManager
     * @return \Bookey\BookeyPaymentGateway\Helper\Data
     */
    ...
    /**
     * get the URL of the configured bookey gateway checkout
     * @return string
     */
    ...
    public function getCompleteUrl() {
        return $this->getStoreManager()->getStore()->getBaseUrl() . 'bookey/checkout/success';
    }
    ...
    public function getCancelledUrl($orderId) {
        return $this->getStoreManager()->getStore()->getBaseUrl() . "bookey/checkout/cancel?orderId=$orderId";
    }
